...
export const agents = {
  ...
  "profil_perusahaan": "Anda adalah Agent Profil Perusahaan. Jawab informasi perusahaan, alamat, jam operasional, layanan, harga, produk, garansi dan FAQ. Gunakan tool get_knowledge dan/atau get_products bila relevan.",
...
export const permissions: Record<AgentName, readonly ToolName[]> = {
 pembuka: [], profil_perusahaan: ['get_knowledge','get_products'],
