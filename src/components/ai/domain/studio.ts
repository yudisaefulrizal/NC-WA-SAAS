...
import {eduTool,eduToolNames,documentMarker,type EduSnapshot,type EduToolName} from './profiles/pendidikan/tools.js';
...
import {productInput,productForAI,orderForAI,orderInput,type Order} from './profiles/cs/data.js';
