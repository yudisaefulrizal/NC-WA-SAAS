...
// Validates what the dashboard sends for contacts, templates and scheduled sends, and shapes rows for it.
...
export function expose(r:RowDataPacket){return {...r,contacts:jsonArray(r.contacts),groups:jsonArray(r.groups_json),enabled:!!r.enabled,template_ids:jsonArray(r.template_ids)};}
