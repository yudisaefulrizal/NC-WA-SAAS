...
// Media of a scheduled share, fetched by WhatsApp through a signed token.
export function assetPublicRoutes(app:express.Express,{gateway}:{gateway:{shareAssets:{getByToken(token:string):Promise<{path:string;mimetype:string}>}}}){
