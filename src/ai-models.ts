...
export const roleTier:Record<ModelRole,ModelTier>={router:'cheap',context:'cheap',pembuka:'cheap',penutup:'cheap',profil_perusahaan:'medium',layanan:'medium',lainnya:'smart',pesanan:'cheap'};
