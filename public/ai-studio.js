...
const names={input:'Pesan masuk',router:'Router',pembuka:'Pembuka',profil_perusahaan:'Profil Perusahaan',layanan:'Layanan',penutup:'Penutup',lainnya:'Lainnya',context:'Context Agent',output:'Jawaban',fallback:'Fallback Tim',memory:'Shared Memory',router_memory:'Router Context',get_knowledge:'Knowledge',get_products:'Produk',check_order:'Cek pesanan',create_order:'Buat pesanan',models:'Model provider'};
const specialists=['pembuka','profil_perusahaan','layanan','penutup','lainnya'];
const positions={input:[35,368],router:[285,368],...Object.fromEntries(specialists.map((id,i)=>[id,[570,70+i*91]])),context:[1060,368],output:[1290,368],fallback:[1060,690],memory:[565,870],router_memory:[1040,870],models:[55,870],get_knowledge:[360,1010],get_products:[595,1010],check_order:[830,1010],create_order:[1065,1010]};
const edges=[['input','router'],...specialists.flatMap(id=>[['router',id],[id,'context'],[id,'fallback']]),['context','output'],['fallback','output'],...specialists.map(id=>['memory',id]),['router_memory','router'],['context','router_memory'],['models','router'],['models','context'],...specialists.map(id=>['models',id]),['profil_perusahaan','get_knowledge'],['profil_perusahaan','get_products'],['layanan','get_knowledge'],['layanan','get_products'],['layanan','check_order'],['layanan','create_order'],['lainnya','get_knowledge'],['lainnya','get_products'],['lainnya','check_order']];
