...
const names={input:'Pesan masuk',router:'Router',pembuka:'Pembuka',informasi:'Informasi',layanan:'Layanan',penutup:'Penutup',lainnya:'Lainnya',context:'Context Agent',output:'Jawaban',fallback:'Fallback Tim',memory:'Shared Memory',router_memory:'Router Context',get_knowledge:'Knowledge',get_products:'Produk',check_order:'Cek pesanan',create_order:'Buat pesanan',models:'Model provider'};
const specialists=['pembuka','informasi','layanan','penutup','lainnya'];
