...
const edges=[['input','router'],...specialists.flatMap(id=>[['router',id],[id,'context'],[id,'fallback']]),['context','output'],['fallback','output'],...specialists.map(id=>['memory',id]),['router_memory','router'],['context','router_memory'],['models','router'],['models','context'],...specialists.map(id=>['models',id]),['profil_perusahaan','get_knowledge'],['layanan','get_knowledge'],['layanan','get_products'],['layanan','check_order'],['layanan','create_order'],['lainnya','get_knowledge'],['lainnya','get_products'],['lainnya','check_order']];
